...
mixin _$OrderEntity {
  ...
  List<TrackingEventEntity> get trackingEvents =>
...
abstract class $OrderEntityCopyWith<$Res> {
  ...
  $Res call(
      ...
      String? carrier,
      List<TrackingEventEntity> trackingEvents,
...
class _$OrderEntityImpl implements _OrderEntity {
  const _$OrderEntityImpl(
      ...
      this.quantity = 1,
      required this.productPriceMru,
      required this.shippingFeeMru,
      required this.serviceFeeMru,
      required this.totalMru,
      this.adminNotes,
      this.weightKg,
      this.trackingNumber,
      this.carrier,
      final List<TrackingEventEntity> trackingEvents = const [],
      final List<PaymentEntity> payments = const [],
      this.paidAt,
      this.purchasedAt,
      this.shippedAt,
      this.arrivedAt,
  ...
  final List<TrackingEventEntity> _trackingEvents;
  @override
  @JsonKey()
  List<TrackingEventEntity> get trackingEvents {
...
abstract class _OrderEntity implements OrderEntity {
  const factory _OrderEntity(
      ...
      final String productCurrency,
      final int quantity,
      required final double productPriceMru,
      required final double shippingFeeMru,
      required final double serviceFeeMru,
      required final double totalMru,
      final String? adminNotes,
      final double? weightKg,
      final String? trackingNumber,
      final String? carrier,
      ...
      required final DateTime updatedAt}) = _$OrderEntityImpl;
